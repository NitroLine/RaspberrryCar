...
int curSpeed = 0;
const int maxSpeed=1860; //1544
const int LowSpeed = 1840; //1539
...
{ 
      ...
      if (millis() - stoptimer > 6000 && !stoping){
        timer=millis();
        curSpeed=1700;
        stoping=1;
      }
...
{      
	    ...
	    curAngle = curAngle*((40.0)/150.0);// пропорционально ументшаем, чтобы угол изменялся от -30 до 30 градусов
