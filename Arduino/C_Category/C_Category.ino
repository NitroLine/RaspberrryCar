...
int curSpeed = 0;
const int maxSpeed=1590; //1544
const int LowSpeed = 1580; //1539
double kf = (maxSpeed - LowSpeed)/30.0; 
const int StopSpeed = 1500;
const int RoadSpeed=1563;
const int ObgonSpeed=1614;
